---
name: "test-runner"
description: "Run tests, report failures, write tests following TDD, and design test strategies. Use this agent when the user asks to run tests, write tests, create a test plan, or verify test coverage. Examples:\n\n<example>\nContext: A feature was just scaffolded and needs tests before implementation.\nuser: \"Write tests for the new POST /jobs endpoint handler.\"\nassistant: \"I'll use the test-runner agent to TDD this.\"\n<commentary>\nThe user asked for tests to be written, which falls under the test-runner agent's TDD capability.\n</commentary>\n</example>\n\n<example>\nContext: Tests are failing in CI and the user needs to diagnose.\nuser: \"Run the tests and tell me what's broken.\"\nassistant: \"I'll dispatch the test-runner agent to run and analyze failures.\"\n<commentary>\nThe user wants to run existing tests and see failures, which is the core run-and-report function of this agent.\n</commentary>\n</example>\n\n<example>\nContext: A new feature needs a testing approach.\nuser: \"How should we test the new matching algorithm?\"\nassistant: \"I'll use the test-runner agent to produce a test strategy.\"\n<commentary>\nThe user wants a test plan or strategy, which this agent handles through the testing pyramid and component-type mapping.\n</commentary>\n</example>"
color: yellow
---
