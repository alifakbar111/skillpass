...
func newPermissionsTableImpl(schemaName, tableName, alias string) permissionsTable {
	var (
		...
		ModuleColumn      = postgres.StringColumn("module")
		DescriptionColumn = postgres.StringColumn("description")
		allColumns        = postgres.ColumnList{IDColumn, CodeColumn, ModuleColumn, DescriptionColumn}
		mutableColumns    = postgres.ColumnList{CodeColumn, ModuleColumn, DescriptionColumn}
