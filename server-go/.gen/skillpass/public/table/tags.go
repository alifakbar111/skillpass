...
type tagsTable struct {
	...
	IndustryCategoryID postgres.ColumnString
...
func newTagsTableImpl(schemaName, tableName, alias string) tagsTable {
	var (
		...
		IndustryCategoryIDColumn = postgres.StringColumn("industry_category_id")
		allColumns               = postgres.ColumnList{IDColumn, NameColumn, IndustryCategoryIDColumn}
		mutableColumns           = postgres.ColumnList{NameColumn, IndustryCategoryIDColumn}
	...
	return tagsTable{
		...
		ID:                 IDColumn,
		Name:               NameColumn,
		IndustryCategoryID: IndustryCategoryIDColumn,
