            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_career.CareerPrediction"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/internal_career.CareerPath"
                            }
                        }
                    }
                }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_career.SkillGapResult"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_companyreviews.Reputation"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/internal_companyreviews.CompanyReview"
                            }
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_companyreviews.CreateReviewRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/MyPermissionsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "internal_career.CareerPath": {
            ...
            "properties": {
                ...
                "skillRequirements": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_career.SkillRequirement"
                    }
                },
                "title": {
                    "type": "string"
                ...
                "typicalProgression": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_career.ProgressionStep"
                    }
                }
            }
        },
        "internal_career.CareerPrediction": {
            ...
            "properties": {
                ...
                "predictedPaths": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_career.PredictedPath"
                    }
                },
                "skillDevelopment": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_career.SkillDevelopment"
                    }
                }
            }
        },
        ...
        "internal_career.SkillGapResult": {
            ...
            "properties": {
                "matchingSkills": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_career.SkillGapItem"
                    }
                },
                "missingSkills": {
                    "type": "array",
